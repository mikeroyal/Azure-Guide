...
![Last-Commit](https://img.shields.io/github/last-commit/mikeroyal/azure-guide?style=for-the-badge)
...
**[Start building with Node.js on Azure](https://aka.ms/azsdk/js)**

**[Node.js Documentation](https://docs.microsoft.com/en-us/javascript/api/overview/azure/?view=azure-node-latest)**
...
**[Start building with Java on Azure](https://aka.ms/azsdk/java)**

**[Java Documentation](https://aka.ms/azsdk/java/docs)**
...
**[Start building with Go on Azure](https://aka.ms/azsdk/go)**

**[Go Documentation](https://aka.ms/azsdk/go/docs)**
...
**[Start building with Python on Azure](https://aka.ms/azsdk/python)**

**[Python Documentation](https://aka.ms/azsdk/python/docs)**
...
**[Start building with Ruby on Azure](https://aka.ms/azsdk/ruby)**

**[Ruby Documentation](https://docs.microsoft.com/en-us/azure/app-service/quickstart-ruby)**
...
**[*unofficial* Azure SDK for Rust](https://github.com/Azure/azure-sdk-for-rust)**. 
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Azure-Guide/pulls).
